...
class UserProfile(models.Model):
    ...
    @property
    def submission_ratio(self):
        return int(self.accepted_problem_number) * 1.0 / int(self.submission_number) * 100
...
class Message(models.Model):
    ...
    who_leave = models.ForeignKey(User, related_name="who_leave_message")
    leave_to = models.ForeignKey(User, related_name="leave_message_to")
