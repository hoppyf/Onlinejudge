...
urlpatterns = [
    ...
    url(r'^problem/(?P<problem_id>\d+)/discussion/$', "problem.views.discussion_page", name="problem_discussion"),
    url(r'^api/discussion/$', ProblemDiscussionAPIView.as_view(), name="leave_discussion"),
    ...
    url(r'^api/leave_message/$', UserLeaveMessageAPIView.as_view(), name="leave_message"),
